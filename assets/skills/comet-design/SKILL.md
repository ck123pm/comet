...
### 0b. Generate Design Harness Context

If `.harness/` exists, immediately generate the current phase harness pack before creating handoff or loading Superpowers:
...
Your task is to perform deep technical design based on the handoff package and harness context: implementation approach, technical risks, testing strategy, boundary conditions.
